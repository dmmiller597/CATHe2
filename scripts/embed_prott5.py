...
def parse_args(argv: List[str] | None = None):
    ...
    p.add_argument("--fasta", default="data/TED/s30/s30_full.fasta", type=Path, help="Input FASTA file")
    ...
    p.add_argument("--max-tokens", type=int, default=80000, help="Token budget per batch")
